...
<?php
    try
    {
        ...
        $last = $last + 1;
        echo("<a href=\"updatemeioint2.php?nummeio={$last}&amp;tipo=MeioCombate\">Inserir novo Meio de Combate</a>\n");
        ...
        foreach($result as $row)
        {
            ...
            echo("</td><td>");
            echo("<a href=\"updatemeioint.php?nummeio={$row['nummeio']}&amp;tipo=MeioCombate\">Editar</a>");
            echo("</td><td>");
